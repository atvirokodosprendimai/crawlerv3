...
ALTER TABLE processing_jobs ADD COLUMN lease_token         BYTEA;
-- +goose StatementEnd
-- +goose StatementBegin
ALTER TABLE processing_jobs ADD COLUMN leased_by_worker_id BIGINT REFERENCES workers(id);
-- +goose StatementEnd
-- +goose StatementBegin
ALTER TABLE processing_jobs ADD COLUMN lease_expires_at    TIMESTAMPTZ;
-- +goose StatementEnd
-- +goose StatementBegin
