...
ALTER TABLE domains             ADD COLUMN embed_collection VARCHAR(128);
-- +goose StatementEnd
-- +goose StatementBegin
ALTER TABLE extracted_documents ADD COLUMN collection       VARCHAR(128);
-- +goose StatementEnd
-- +goose StatementBegin
...
-- +goose StatementEnd
-- +goose StatementBegin
DROP INDEX idx_extracted_collection ON extracted_documents;
-- +goose StatementEnd
-- +goose StatementBegin
